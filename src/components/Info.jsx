  ...
  return (
    <div className="text-white">
      ...
      {loading ? (
        ...
        <div
          className="bg-center bg-no-repeat bg-cover pt-16 px-6 min-h-screen flex lg:px-32"
          style={{
        ...
        >
          <div className="flex flex-col mt-6 lg:flex-row lg:items-center xl:px-28 2xl:px-56">
            <img
              loading="lazy"
              className="w-60 rounded-lg self-center lg:w-80 2xl:w-1/3"
            ...
            <div className="flex flex-col items-center lg:items-start lg:pl-14">
              ...
              <div className="flex gap-4 justify-center">
                {item.genres.map((genre) => (
                  <h2
                    key={genre.id}
                    className="px-4 py-2 border rounded-full self-center 2xl:text-3xl"
                  >
                    {genre.name}
                  </h2>
                ))}
              </div>
              <div className="w-80 grid grid-rows-2 grid-cols-2 justify-items-center gap-y-2 my-6 text-lg lg:justify-items-start 2xl:text-3xl 2xl:w-96">
                <h2>Release date:</h2>
              ...
              <h2 className="italic opacity-60 2xl:text-5xl">{item.tagline}</h2>
              <div className="self-start py-6 sm:px-16 lg:px-0 2xl:text-3xl">
                <h2 className="font-medium text-xl pb-2 2xl:text-4xl">
                  Overview
                </h2>
                <p>{item.overview}</p>
              </div>
